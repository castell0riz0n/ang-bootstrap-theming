...
@Component({
  ...
  template: `
    <div class="search-panel">
      ...
      <form [formGroup]="searchForm" (ngSubmit)="searchFlights()">
        ...
        <div class="row g-3">
          <!-- From Airport with input group icons -->
          <div class="col-md-6">
          ...
          <!-- To Airport with input group icons -->
          <div class="col-md-6">
          ...
          <!-- Return Date (conditionally shown) with calendar icon -->
  ...
  styles: [`
    ...
    // Specifically handling the input-group for RTL
    .input-group {
      .input-group-text {
        background-color: var(--bs-primary);
        color: white;
